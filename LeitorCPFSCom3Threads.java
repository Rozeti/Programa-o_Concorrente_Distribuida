...
public class LeitorCPFSCom3Threads {
    ...
    public static void main(String[] args) {
        ...
        // Threads
        Thread t1 = new Thread(() -> processarArquivos(1, 10, pastaCPFS));
        Thread t2 = new Thread(() -> processarArquivos(11, 20, pastaCPFS));
        Thread t3 = new Thread(() -> processarArquivos(21, 30, pastaCPFS));
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("versao3threads.txt"))) {
