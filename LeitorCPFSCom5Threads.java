...
public class LeitorCPFSCom5Threads {
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> processarArquivos(1, 6, pastaCPFS));
        Thread t2 = new Thread(() -> processarArquivos(7, 12, pastaCPFS));
        Thread t3 = new Thread(() -> processarArquivos(13, 18, pastaCPFS));
        Thread t4 = new Thread(() -> processarArquivos(19, 24, pastaCPFS));
        Thread t5 = new Thread(() -> processarArquivos(25, 30, pastaCPFS));
