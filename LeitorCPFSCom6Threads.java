...
public class LeitorCPFSCom6Threads {
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> processarArquivos(1, 5, pastaCPFS));
        Thread t2 = new Thread(() -> processarArquivos(6, 10, pastaCPFS));
        Thread t3 = new Thread(() -> processarArquivos(11, 15, pastaCPFS));
        Thread t4 = new Thread(() -> processarArquivos(16, 20, pastaCPFS));
        Thread t5 = new Thread(() -> processarArquivos(21, 25, pastaCPFS));
        Thread t6 = new Thread(() -> processarArquivos(26, 30, pastaCPFS));
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("versao6threads.txt"))) {
